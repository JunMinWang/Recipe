...
<head>
    ...
    <title>iCooking -- Love Sharing</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/home') }}">
                        <span class='glyphicon glyphicon-cutlery' aria-hidden='true'></span> iCooking
                    </a>
                </div>
                        ...
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                      <a href="{{ route('getCreateRecipe') }}">
                                        <span class='glyphicon glyphicon-plus' aria-hidden='true'></span>  新食譜
                                      </a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
